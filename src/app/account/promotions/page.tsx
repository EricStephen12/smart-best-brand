    ...
    return (
        <div className="space-y-10 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-blue-950 tracking-tight uppercase leading-none mb-2">Promotions Hub</h1>
                    <p className="text-slate-400 font-medium font-inter">Manage discount codes and promotions for your store.</p>
                </div>
                <Link
