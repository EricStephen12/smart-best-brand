        ...
        <div className="min-h-screen bg-slate-50 pt-24 pb-12 flex items-center justify-center">
            <div className="max-w-xl w-full px-4 sm:px-6">
                <motion.div
                    ...
                    className="bg-white rounded-[2.5rem] p-8 sm:p-12 shadow-2xl shadow-blue-950/10 text-center border border-slate-100"
                >
                    <div className="w-20 h-20 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-8">
                        <CheckCircle2 className="w-10 h-10 text-green-500" />
                    </div>

                    <h1 className="text-3xl sm:text-4xl font-black text-blue-950 uppercase tracking-tight mb-4">
                        Payment Secured
                    </h1>
